...
import pse_gui.Comm.PowershellEmpireConnection;
...
public class Model {
	...
	private pse_gui.Models.SSHInformations SSHInformations;
	...
	public synchronized void setUserRequest(UserRequest userRequest) {
